...
const galeryImagesArray = [
  "/static/img/Rectangle2602.png",
  "/static/img/Rectangle2623.png",
  "/static/img/Rectangle2602.png",
  "/static/img/Rectangle2644.png",
];
...
const ServicesLandingCabinets = () => {
  ...
  return (
    <div>
      <ServicesHeader headerBg="/static/img/Rectangle1.png">
        <LandingHeaderButtonGroup>
        ...
        <LandingHeaderTitle>Встроенные шкафы</LandingHeaderTitle>
      </ServicesHeader>
      <ServiceTypes>
        <ServiceTypeItem>
        ...
        <ServiceWorkInfo>
          ...
          <ServiceWorkInfoBlockRow className="forf-row">
            <ServiceWorkInfoBlockAbout>
              ...
              <ServiceWorkInfoBlockAboutText>
                Мы{" "}
                <span className="text-lightblue">привозим вам гардеробную</span>{" "}
                в удобное время. В течение 3-х дней собираем её.
              </ServiceWorkInfoBlockAboutText>
            </ServiceWorkInfoBlockAbout>
            <ServiceWorkInfoBlockImage source="/static/img/Rectangle2461.png" />
          </ServiceWorkInfoBlockRow>
        </ServiceWorkInfo>
      </Section>
      <Section>
        ...
        <ServiceConstructor>
          <Row className=" ml-0 mr-0 constructor-row">
            ...
            <ConstructorBox>
              <ConstructorImagePreviewBox>
                <ConstructorImagePreview source="/static/img/vstroennyj-shkaf-kupe-v-spalnyu-042.png" />
                <ConstructorImagePreviewAbout>
                  Условное описание крепления или иные преимущества
                </ConstructorImagePreviewAbout>
              </ConstructorImagePreviewBox>
              <ConstructorImagePreviewLine className="cabinet-constructor-line" />
              <ConstructorImageBox source="/static/img/vstroennyj-shkaf-kupe-v-spalnyu-041.png" />
            </ConstructorBox>
          </Row>
          <ConstructorInfoBox className="cabinets-constructor-info-box">
      ...
      <Section style={{ backgroundColor: "#fff" }}>
        ...
        <ServiceChoice>
          <ServiceChoiceAbout>
            <ServiceChoiceBtnGroup>
              <ServiceChoiceBtn active>Габариты</ServiceChoiceBtn>
          ...
          <ServiceChoiceImage source="/static/img/Rectangle2535.png" />
        </ServiceChoice>
      </Section>
      ...
      <Section style={{ backgroundColor: "#fff" }}>
        <SectionTitle
          ...
          className="landing-section-title"
        >
          Посмотрите галерею шкафов
        </SectionTitle>
        <SreviceGaleryBlock galeryImagesArray={galeryImagesArray}>
          <ServiceGaleryItem>
            <ServiceGaleryItemImage source="/static/img/Rectangle2608.png" />
          </ServiceGaleryItem>
          <ServiceGaleryItem>
            <ServiceGaleryItemImage source="/static/img/Rectangle2608.png" />
          </ServiceGaleryItem>
      ...
      <Section style={{ backgroundColor: "#e5e5e5" }}>
        <SectionTitle
          ...
          className="landing-section-title"
        >
          Полезные аксессуары для встроенных шкафов
        </SectionTitle>
        <ServiceUtility>
          <ServiceUtilityItem>
            <ServiceUtilityItemItemImage source="/static/img/72875-cosmorelax-image1.png" />
            <ServiceUtilityItemItemAbout>
              <ServiceUtilityItemName>
          ...
          <ServiceUtilityItem>
            <ServiceUtilityItemItemImage source="/static/img/unnamed1.png" />
            <ServiceUtilityItemItemAbout>
              <ServiceUtilityItemName>
                Условное название аксессуара
              </ServiceUtilityItemName>
...
export default ServicesLandingCabinets;
