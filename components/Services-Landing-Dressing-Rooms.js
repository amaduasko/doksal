...
const ServicesLandingDressingRooms = () => {
  ...
  return (
    <div>
      <ServicesHeader headerBg="/static/img/Rectangle10.png">
        <LandingHeaderButtonGroup>
        ...
        <LandingHeaderTitle>Гардеробные</LandingHeaderTitle>
      </ServicesHeader>
      <ServiceTypes>
        <ServiceTypeItem>
      ...
      <Section style={{ paddingTop: "0" }}>
        <ServiceWorkInfo>
          ...
          <ServiceWorkInfoBlockRow className="forf-row">
            ...
            <ServiceWorkInfoBlockImage source="/static/img/Rectangle2469.png" />
          </ServiceWorkInfoBlockRow>
        </ServiceWorkInfo>
      </Section>
      <Section>
        ...
        <ServiceConstructor>
          <Row className=" ml-0 mr-0 constructor-row">
            <ConstructorMenu />
            <ConstructorBox>
              <ConstructorImagePreviewBox className="dressing-room-image-preview-box">
                <ConstructorImagePreview source="/static/img/examples-032.png" />
                <ConstructorImagePreviewAbout>
                  Условное описание крепления или иные преимущества
                </ConstructorImagePreviewAbout>
              </ConstructorImagePreviewBox>
              <ConstructorImagePreviewLine className="dressing-room-constructor-line" />
              <ConstructorImageBox source="/static/img/examples-031.png" />
            </ConstructorBox>
          </Row>
          <ConstructorInfoBox className="dressing-room-constructor-infobox">
      ...
      <Section style={{ backgroundColor: "#fff" }}>
        ...
        <ServiceChoice>
          ...
          <ServiceChoiceImage source="/static/img/Rectangle25350.png" />
        </ServiceChoice>
      </Section>
      ...
      <Section style={{ backgroundColor: "#fff" }}>
        <SectionTitle
          ...
          className="landing-section-title"
        >
          Посмотрите галерею гардеробных
        </SectionTitle>
        <SreviceGaleryBlock galeryImagesArray={galeryImagesArray}>
          <ServiceGaleryItem>
            <ServiceGaleryItemImage source="/static/img/Rectangle26085.png" />
          </ServiceGaleryItem>
          <ServiceGaleryItem>
            <ServiceGaleryItemImage source="/static/img/Rectangle26085.png" />
          </ServiceGaleryItem>
      ...
      <Section style={{ backgroundColor: "#e5e5e5" }}>
        ...
        <ServiceUtility>
          <ServiceUtilityItem>
            <ServiceUtilityItemItemImage source="/static/img/someimage.png" />
            <ServiceUtilityItemItemAbout>
              <ServiceUtilityItemName>
...
export default ServicesLandingDressingRooms;
